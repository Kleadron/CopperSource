namespace QoiSharp.Codec
{
    ...
    public static class QoiCodec
    {
        ...
        /// enough for anybody.
        /// </summary>
        public static int MaxPixels = 400000000;
        ...
        public static readonly int Magic = CalculateMagic(MagicString.ToCharArray());
        ...
        {
            return CalculateMagic(magic) == Magic;
        }
    
        private static int CalculateMagic(char[] chars) 
        {
            return chars[0] << 24 | chars[1] << 16 | chars[2] << 8 | chars[3];
        }
        private static int CalculateMagic(byte[] data) 
        {
